...
sys_ipc_recv(void *dstva)
{
  ...
  8002f4:	68 cf 0f 80 00       	push   $0x800fcf
  8002f9:	6a 23                	push   $0x23
  8002fb:	68 ec 0f 80 00       	push   $0x800fec
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800349:	56                   	push   %esi
  80034a:	50                   	push   %eax
  80034b:	68 fc 0f 80 00       	push   $0x800ffc
  ...
  80035c:	e8 54 00 00 00       	call   8003b5 <vcprintf>
	cprintf("\n");
  800361:	c7 04 24 20 10 80 00 	movl   $0x801020,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8004b4:	0f be 80 22 10 80 00 	movsbl 0x801022(%eax),%eax
  8004bb:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80068a:	50                   	push   %eax
  80068b:	68 3a 10 80 00       	push   $0x80103a
  800690:	53                   	push   %ebx
  800691:	56                   	push   %esi
  ...
  8006a2:	52                   	push   %edx
  8006a3:	68 43 10 80 00       	push   $0x801043
  8006a8:	53                   	push   %ebx
  8006a9:	56                   	push   %esi
  ...
  8006c7:	b8 33 10 80 00       	mov    $0x801033,%eax
