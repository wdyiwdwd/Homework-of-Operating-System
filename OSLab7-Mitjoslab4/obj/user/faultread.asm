	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001e7:	0f be 80 e8 0f 80 00 	movsbl 0x800fe8(%eax),%eax
  8001ee:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003bd:	50                   	push   %eax
  8003be:	68 00 10 80 00       	push   $0x801000
  8003c3:	53                   	push   %ebx
  8003c4:	56                   	push   %esi
  ...
  8003d5:	52                   	push   %edx
  8003d6:	68 09 10 80 00       	push   $0x801009
  8003db:	53                   	push   %ebx
  8003dc:	56                   	push   %esi
  ...
  8003fa:	b8 f9 0f 80 00       	mov    $0x800ff9,%eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800cf2:	56                   	push   %esi
  800cf3:	50                   	push   %eax
  800cf4:	68 50 12 80 00       	push   $0x801250
  ...
  800d05:	e8 de f3 ff ff       	call   8000e8 <vcprintf>
	cprintf("\n");
  800d0a:	c7 04 24 dc 0f 80 00 	movl   $0x800fdc,(%esp)
